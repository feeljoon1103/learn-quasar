<template>
  <q-page class="q-pa-xl">
    ...
    <section class="q-mb-xl">
      ...
      <q-separator class="q-my-md"/>
      <div class="ellipsis">
        Apply dark transparent overlay on top of your element. Do not use on elements which already have :after pseudoelement. dkqmcwpdmkcqpwodmkcpqwodkmpqwkmdcpq
      </div>
      <hr>
